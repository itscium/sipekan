...
@section('content_header')
    <h1 class="m-0 text-dark">Department Expense Report - Special Travel</h1>
@stop
                        ...
                        <table class="table table-sm table-striped table-head-fixed">
                            ...
                            @foreach($data as $index=>$item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('report.departemen.special.detail', ['id_departemen' => $item['id']]) }}" class="btn btn-success btn-xs"><i class="fas fa-eye"></i> Details</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
