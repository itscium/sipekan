...
@section('content_header')
    <h1 class="m-0 text-dark">Department Expense Report - Strategic Plan</h1>
@stop
                        ...
                        <table class="table table-striped table-head-fixed">
                            ...
                            @foreach($data as $index=>$item)
                                <tr>
                                    ...
                                    <td>{{$item['sisa']}}</td>
                                    <td>
                                        <a href="{{ route('report.departemen.strategic.detail', ['id_departemen' => $item['id']]) }}" class="btn btn-success btn-sm"><i class="fas fa-eye"></i> Details</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
